...
6. Set Licence ???
7. Click `Continue`
8. Copy content of [smart-contracts/Originstamp.sol](https://github.com/IPBee/blockchain/blob/master/smart-contracts/Originstamp.sol) and past it in text field
